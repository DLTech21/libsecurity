...
// #ifdef __ANDROID__
    ...
    JNIEXPORT jbyteArray JNICALL Java_io_github_dltech21_Security_EncryptByKey(JNIEnv* env, jobject obj, jstring jstr, jstring jstrKey)
    {
     ...
     * 解密
     */
    JNIEXPORT jbyteArray JNICALL Java_io_github_dltech21_Security_DecryptByKey(JNIEnv* env, jobject obj, jstring jstr, jstring jstrKey)
    {
    ...
    JNIEXPORT jbyteArray JNICALL Java_io_github_dltech21_Security_EncryptContent(JNIEnv* env, jobject obj, jstring jstr)
    {
        const char *pInData = env->GetStringUTFChars(jstr, NULL);       //待加密内容,转换格式
        uint32_t nInLen = strlen(pInData);
     ...
     * 解密
     */
    JNIEXPORT jbyteArray JNICALL Java_io_github_dltech21_Security_DecryptContent(JNIEnv* env, jobject obj, jstring jstr)
    {
        const char *pInData = env->GetStringUTFChars(jstr, NULL);   //获取待揭秘内容,转换格式
        uint32_t nInLen = strlen(pInData);
        string strInData(pInData, nInLen);
    ...
    JNIEXPORT jbyteArray JNICALL Java_io_github_dltech21_Security_EncryptPass(JNIEnv* env, jobject obj, jstring jstr)
    {
        const char *pInData = env->GetStringUTFChars(jstr, NULL);		//待加密内容,转换格式
        uint32_t nInLen = strlen(pInData);
